export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd7783d7fc7a9c8b7",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "f79b1d33edcfb810c4bfccfe3f0fcf6d",
  ...
  USERS: [
    {
      ...
      id: "ooA2a6PXO1yRKg2n7zRCRGEVsd1A",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "vCVWjHS23BtkEs5Ae_A7ZvhJjXgWN6PqlH6TcICkl4s",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "南充",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "乒乓", "year": "2000", "date": "11-14"},
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 相识的日子
        {"keyword": "acquaintance _day", date: "2015-06-11"},
      name: "老婆1",
      id: "",
      useTemplateId: "",
      province: "",
